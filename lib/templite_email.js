                            ...
                            <table class="cti-button" border="0" cellpadding="0" cellspacing="0" width="" style="border-collapse:separate!important;background:#43c9f0;border-radius:5px;border:0;margin:0 auto;table-layout:fixed" align="left">
                              <tbody><tr>
                                <td style="padding:12px 20px" align="center">
                                  <a href="https://ctee.kr/store/content/${store_order_id}" target="_blank" style="font-size:14px;display:block;color:#ffffff;text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">콘텐츠 확인하기</a>
                                </td>
                              </tr></tbody>
                            </table>
                          </td>
                              ...
                              <tbody><tr>
                                <td style="width:100%">
                                  <div style="text-align:left;line-height:1.71;font-size:14px;font-family:'Apple SD Gothic Neo','AppleSDGothicNeo','Noto Sans KR',sans-serif;font-weight:500;font-stretch:normal;font-style:normal;letter-spacing:normal;color:#808080;">
                                    (주)나인에이엠 / 서울시 마포구 독막로 331 마스터즈타워 2501 / 고객센터 <a href="tel:070-8819-4308" style="color:#43c9f0" target="_blank"><font color="#43c9f0">070-8819-4308</font></a> / 이메일 <a href="mailto:contact@ctee.kr" style="color:#43c9f0;text-decoration:underline" target="_blank">contact@ctee.kr</a> / 카카오톡 <a href="http://pf.kakao.com/_JUxkxjM/chat" style="color:#43c9f0;text-decoration:underline">@크라우드티켓</a>
                                  </div>
                                </td>
                              </tr></tbody>
                            </table>
                     ...
                     <tbody><tr>
                       <td style="padding:0 0;border:0px" width="100%">
                         <table class="cti-button" border="0" cellpadding="0" cellspacing="0" width="" style="border-collapse:separate!important;background:#43c9f0;border-radius:5px;border:0;margin:0 auto;table-layout:fixed" align="left">
                           <tbody><tr>
                             <td style="padding:12px 20px" align="center">
                               <a href="https://ctee.kr/store" target="_blank" style="font-size:14px;display:block;color:#ffffff;text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">다시 콘텐츠 상점으로</a>
                             </td>
                           </tr></tbody>
                         </table>
                       </td>
                       ...
                       <td style="width:100%;max-width:630px;border-collapse:collapse;padding:0 20px;overflow:hidden">
                         ...
                         <table class="contact-info-block" border="0" cellpadding="0" cellspacing="0" align="left" style="padding:20px 0;table-layout:fixed" width="100%">
                           <tbody><tr>
                             <td style="width:100%">
                               <div style="text-align:left;line-height:1.71;font-size:14px;font-family:'Apple SD Gothic Neo','AppleSDGothicNeo','Noto Sans KR',sans-serif;font-weight:500;font-stretch:normal;font-style:normal;letter-spacing:normal;color:#808080;">
                                 (주)나인에이엠 / 서울시 마포구 독막로 331 마스터즈타워 2501호 / 고객센터 <a href="tel:070-8819-4308" style="color:#43c9f0" target="_blank"><font color="#43c9f0">070-8819-4308</font></a> / 이메일 <a href="mailto:contact@ctee.kr" style="color:#43c9f0;text-decoration:underline" target="_blank">contact@ctee.kr</a> / 카카오톡 <a href="http://pf.kakao.com/_JUxkxjM/chat" style="color:#43c9f0;text-decoration:underline">@크라우드티켓</a>
                               </div>
                             </td>
                           </tr></tbody>
                         </table>
                     ...
                     <tbody><tr>
                       <td style="padding:0 0;border:0px" width="100%">
                         <table class="cti-button" border="0" cellpadding="0" cellspacing="0" width="" style="border-collapse:separate!important;background:#43c9f0;border-radius:5px;border:0;margin:0 auto;table-layout:fixed" align="left">
                           <tbody><tr>
                             <td style="padding:12px 20px" align="center">
                               <a href="https://ctee.kr/users/store/${user_id}/orders" target="_blank" style="font-size:14px;display:block;color:#ffffff;text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">나의 콘텐츠로 이동</a>
                             </td>
                           </tr></tbody>
                         </table>
                       </td>
               ...
               <tbody><tr style="margin:0;padding:0">
                 <td style="width:100%;max-width:630px;border-collapse:separate;padding:0 20px;overflow:hidden">
                   ...
                   <table class="cti-button" border="0" cellpadding="0" cellspacing="0" width="" style="border-collapse:separate!important;background:#43c9f0;border-radius:5px;border:0;margin:0 auto;table-layout:fixed" align="left">
                     <tbody><tr>
                       <td style="padding:12px 20px" align="center">
                         <a href="https://ctee.kr/manager/store" target="_blank" style="font-size:14px;display:block;color:#ffffff;text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">상점 관리 페이지로 이동</a>
                       </td>
                     </tr></tbody>
                   </table>
                 </td>

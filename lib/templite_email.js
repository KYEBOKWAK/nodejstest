...
let logo_dom = function() {
  ...
  <tbody><tr>
    <td>
      <img alt="크티 로고" src="https://crowdticket0.s3.ap-northeast-1.amazonaws.com/admin/mail/rebrand/v.3.0_ctee_symbol_black.png" class="ic_cti_symbol" style="width:32px; height:32px; object-fit: contain;" />
    </td>
  </tr></tbody>
</table>`
}
...
module.exports = {
                      ...
                      <table class="button-block" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:0px;width:100%;max-width:630px;clear:both;background:none">
                        <tbody><tr>
                          <td style="padding:0 0;border:0px" width="100%">
                            <a href="${URL(`/manager/store`)}" target="_blank" style="text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">
 ...
 email_store_order_rejected: {
  ...
  html: function(store_manager_name, order_name, item_title, refund_reason, language_code){
    return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                ...
                <tbody><tr style="margin:0;padding:0">
                  <td style="width:100%;max-width:630px;border-collapse:separate;padding:0 20px;overflow:hidden">
                    ...
                    <table class="button-block" border="0" cellpadding="0" cellspacing="0" style="overflow:hidden;margin:0px auto;padding:0px;width:100%;max-width:630px;clear:both;background:none">
                      <tbody><tr>
                        <td style="padding:0 0;border:0px" width="100%">
                          <a href="${URL(`/home`)}" target="_blank" style="text-decoration:none;font-family:'Noto Sans KR',sans-serif;text-align:center">
                            <div style="width: 100%;padding: 12px 0px;background:#191919;border-radius: 4px;font-size: 14px;font-weight: bold;color:#ffffff;">

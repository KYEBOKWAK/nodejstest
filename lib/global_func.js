...
module.exports = {
  ...
  sendKakaoAlimTalk(datas){
    ...
    if(_templateCode === 'CTSTORE01a'){
    ...
    else if(_templateCode === 'CTSTORE02c'){
        _content = `[크티 주문승인]\n크리에이터에게 요청하신 콘텐츠가 승인되었습니다!\n\n■ 크리에이터: ${data.creator_name}\n■ 상품명: ${data.item_title}\n\n${data.customer_name}님의 콘텐츠 시작 시간이 정해졌습니다.\n크리에이터와의 실시간 콘텐츠 진행을 위해 아래 버튼을 눌러 일정을 확인해주세요.`;
        ...
        _smsContent = '[크티] 크리에이터가 요청을 승인했습니다! 콘텐츠 진행시간을 웹사이트에서 확인해주세요.';
    }

module.exports = {
  ...
  pay_isp_type: {
    isp_store_item: 'isp_store_item',
    isp_donation: 'isp_donation',
  ...
  thumbnails: {
    ...
    look_around_recommend_place: 9, //0번째가 firstText임
    magazines: 10,
  ...
  file_upload_target_type: {
    ...
    business_bank_copy: 'business_bank_copy',
  },
  ...
  order: {
    ...
    ORDER_STATE_APP_PAY_SUCCESS_DONATION: 19, //도네이션 결제 완료
